...
import { Align, Bounds, Point, StyledTokens, FinalToken, SplitStyle, TextStyleExtended, ParagraphToken, LineToken, WordToken, Nested, VAlign, FontMap } from "./types";
...
declare type AlignFunction = (line: Bounds[]) => Bounds[];
declare type AlignFunctionMaxWidth = (maxWidth: number) => AlignFunction;
...
export declare const calculateFinalTokens: (styledTokens: StyledTokens, splitStyle?: SplitStyle, scaleIcons?: boolean, adjustFontBaseline?: FontMap) => ParagraphToken;
